...
@media screen and (max-width: 600px) {
  ...
  <body>
    <ul>
      ...
      <li><a class="active" href="#department">Department</a></li>
  ...
  <!-- <li><a href="tables.php">Table</a></li> -->
    ...
    <h1>Enter data about department</h1>
    <br>

  <div class="container">
    <form class="" action="action1.php" method="post">
      <div class="row">
        <div class="col-25">
        ...
        <div class="col-75">
          <input type="text" name="dept_name" placeholder="Department name" value=""required="">
