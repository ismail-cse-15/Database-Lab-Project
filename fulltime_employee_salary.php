 ...
 * {
 ...
 @media screen and (max-width: 600px) {
  ...
  <!-- <li><a href="tables.php">Table</a></li> -->
    ...
    <!-- <p>You are a full time employee</p> -->
    <h1>Enter data about full time employee</h1>
    <div class="container">
      <form class="" action="full_part.php" method="post">
        <div class="row">
          <div class="col-25">
          ...
          <div class="col-75">
            <input type="number" name="emp_no" placeholder="Employee no"value="" min="101" required>
        ...
        <div class="row">
         ...
         <div class="col-75">
           <input type="number" name="basic" placeholder="Basic" value="" min="5000" required>
        ...
        <div class="row">
          ...
          <div class="col-75">
            <input type="date" name="salary_date"  placeholder="Salary date" value="" required>
