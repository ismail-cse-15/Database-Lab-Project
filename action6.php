...
$query="SELECT employee.type_of_work FROM employee
WHERE emp_ID='$emp_no'";
$send=mysqli_query($connection,$query);
$row=mysqli_fetch_array($send);

if($row['type_of_work']=='F')
{

    header("Location:fulltime_employee_salary.php");
...
else
{
  ...
  header("Location:parttime_employee_salary.php");
