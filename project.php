...
@media screen and (max-width: 600px) {
 ...
 <!-- <link rel="stylesheet" type="text/css" href="input_style.css"> -->
   ...
   <!-- <li><a href="tables.php">Table</a></li> -->
     ...
     <h1>Enter data about project</h1>
     <br>

     <div class="container">
       <form class="" action="action4.php" method="post">
         <div class="row">
           <div class="col-25">
           ...
           <div class="col-75">
             <input type="text" name="project_name" placeholder="Project name" value=""required>
         ...
         <div class="row">
           <div class="col-25">
             <label for="">Priject location</label>

           </div>
           <div class="col-75">
             <input type="text" name="project_location" placeholder="Project location" value=""required>
           </div>
