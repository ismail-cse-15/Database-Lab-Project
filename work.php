...
@media screen and (max-width: 600px) {
   ...
   <!-- <li><a href="tables.php">Table</a></li> -->
     ...
     <h1>Enter data about work</h1>
     <br>


    <div class="container">
      <form class="" action="action5.php" method="post">
        <div class="row">
          <div class="col-25">
          ...
          <div class="col-75">
            <input type="number" name="project_id" placeholder="Project ID"  value="" min="901" required>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-75">
            <input type="number" name="emp_id" placeholder="Employee ID"  value="" min="101" required>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-75">
            <input type="number" name="num_of_hours" placeholder="Number of hours"  value="" min="1" required>
          </div>

        </div>
        <div class="row">
          <div class="col-25">
            <label for="">Works date</label>

          </div>
          <div class="col-75">
            <input type="date" name="works_date" placeholder="Works date"  value="" required>
          </div>
