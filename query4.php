...
$query="SELECT employee.emp_name
FROM employee,project,ft_pt_work,department
WHERE ft_pt_work.emp_id=employee.emp_ID
AND project.project_ID=ft_pt_work.project_id
AND ft_pt_work.dept_id=department.dept_ID
AND employee.dept_ID=department.dept_ID
AND project.project_name='Googong Subdivision'
AND employee.emp_name IN(SELECT employee.emp_name
FROM employee,project,ft_pt_work,department
WHERE ft_pt_work.emp_id=employee.emp_ID
AND project.project_ID=ft_pt_work.project_id
AND ft_pt_work.dept_id=department.dept_ID
AND employee.dept_ID=department.dept_ID
AND project.project_name='Burton Highway') GROUP BY
employee.emp_name";
