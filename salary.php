...
@media screen and (max-width: 600px) {
         ...
         <li><a  href="address.php">Address</a></li>
           <li><a href="project.php">Project</a></li>
             <li><a href="work.php">Work</a></li>
                <li><a class="active" href="#salary">Salary</a></li>
             <li class="dropdown">
 ...
 <!-- <li><a href="tables.php">Table</a></li> -->
     ...
     <h1>Enter data about employee's salary</h1>
    <br>
    <div class="container">
      <form class="" action="action6.php" method="post">
        <div class="row">
          <div class="col-25">
        ...
        <div class="row">
          <input type="submit" name="s1" value="Check employee type">
